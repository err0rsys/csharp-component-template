...
namespace DomConsult.GlobalShared.Utilities
{
    ...
    public sealed class ComWrapper : IDisposable
    {
        ...
        {
            get {
                return ComRemoteMode ? m_serverName : "localhost";
            }
        ...
        public bool Connect(string progID, Guid COMPartition)
        {
            try
            {
                ...
                comType = Type.GetTypeFromProgID(progID, "127.0.0.1", true);
                Guid classID = comType.GUID;
        ...
        public bool ConnectRemote(string progID, string serverNameOrIP)
        {
            ...
            {
                return Connect(progID, Guid.Empty);
            }
            else
            {
                try
        ...
        public object InvokeMethod(string methodName, object[] arguments, bool[] argsByRef, ref string exception)
        {
            if (arguments != null)
            {
                ...
                return comType.InvokeMember(methodName, BindingFlags.InvokeMethod | BindingFlags.IgnoreCase, null, comObject, arguments, new ParameterModifier[] { modifier }, null, null);
            }
            else
            {
